...
export class LatestOrdersComponent implements OnInit {
  public orders = [
    ...
    { number: '3145', date: 'Febrero 14, 2018', status: 'En espera', total: '$255.000,99 - 1productos', invoice: false },
    ...
    { number: '1781', date: 'Septiembre 3, 2017', status: 'Cancelado', total: '$49.000,00 - 2 productos', invoice: false }
  ]
  constructor() { }
