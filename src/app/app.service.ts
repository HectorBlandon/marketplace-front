...
export class AppService {
    ...
    public getBrands(){
        return [
            { name: 'aguardiente1', image: 'assets/images/brands/aguaAntioquenio.png' },
            { name: 'aguardiente2', image: 'assets/images/brands/aguaAmarillo.png' },
            { name: 'aguardiente3', image: 'assets/images/brands/aguaCristal.png' },
            { name: 'cerveza1', image: 'assets/images/brands/cervezaAgila.png' },
            { name: 'cerveza2', image: 'assets/images/brands/cervezaAndina.png' },
            { name: 'cerveza3', image: 'assets/images/brands/cervezaClubColombia.png' },
            { name: 'cerveza4', image: 'assets/images/brands/cervezaCorona.png' },
            { name: 'cerveza5', image: 'assets/images/brands/cervezaPoker.png' },
            { name: 'cocaCola', image: 'assets/images/brands/cocaCola.png' },
            { name: 'ron1', image: 'assets/images/brands/ronCaldas.png' },
            { name: 'ron2', image: 'assets/images/brands/ronMedellin.png' },
            { name: 'tequila1', image: 'assets/images/brands/tequilaJCuervo.png' },
            { name: 'tequila2', image: 'assets/images/brands/tequilaJimador.png' }
        ];
    }
